...
function TP(Object) -- Object = part teleporting to.
    ...
    local tween = tweenService:Create(game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart, tweenInfo, {CFrame = CFrame.new(Object.Position + Vector3.new(0,3,0))})
    tween:Play()  
end
